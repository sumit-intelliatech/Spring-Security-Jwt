...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        // only the Token
        if (requestTokenHeader != null && requestTokenHeader.startsWith(Constants.BEARER_PREFIX)) {
...
//
//            final UserDetails userDetails = this.jwtUserDetailsService.loadUserByUsername(email);
//
//            // if token is valid configure Spring Security to manually set
//
//            if (jwtUtil.validateJwtToken(jwtToken, userDetails)) {
